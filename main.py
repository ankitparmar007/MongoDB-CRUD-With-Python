...
def createNewUserGet(userEmail: str = "",userName:str="",userPassword:str=""):
    try:
...
def readUsername(userEmail: str = "",userPassword:str=""):
    find_user_doc = collection.count_documents({"user_email":userEmail}, limit = 1)
    if find_user_doc > 0:
...
def updateUser(userEmail: str = "",userName:str="",userPassword:str=""):
...
# @app.get("/deleteUser/")
def deleteUser(userEmail: str = "",userPassword:str=""):
